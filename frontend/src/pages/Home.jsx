      ...
      <Section background="gray" padding="sm">
        <div className="text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            {[
              { label: language === 'TR' ? 'ISO 9001' : 'ISO 9001', color: 'primary' },
              { label: language === 'TR' ? 'CE Sertifikalı' : 'CE Certified', color: 'secondary' },
              { label: language === 'TR' ? 'EN Standartları' : 'EN Standards', color: 'success' },
              { label: language === 'TR' ? 'OEKO-TEX' : 'OEKO-TEX', color: 'primary' }
            ].map((badge, index) => (
      ...
      <Section background="blue" padding="default">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            {language === 'TR' ? 'Hizmet Özelliklerimiz' : 'Our Service Features'}
          </h2>
