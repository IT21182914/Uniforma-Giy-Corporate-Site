    ...
    TR: [
      {
        ...
        description:
          "Kalite yönetim sistemimizin uluslararası standartlara uygunluğunu belgeleyen sertifika.",
        issuer: "TÜV Türk",
      ...
      },
      {
        ...
        description:
          "Ürünlerimizin Avrupa Birliği güvenlik standartlarına uygunluğunu belgeleyen sertifika.",
      ...
      },
      {
        ...
        description:
          "Yüksek görünürlük özellikli iş kıyafetlerimizin standartlara uygunluk belgesi.",
      ...
      },
      {
        ...
        description:
          "Tekstil ürünlerimizin insan sağlığına zararlı madde içermediğini belgeleyen sertifika.",
      ...
      },
      {
        ...
        description:
          "İş sağlığı ve güvenliği risk değerlendirmesi yeterlilik belgesi.",
    ...
    EN: [
      {
        ...
        description:
          "Certificate documenting compliance of our quality management system with international standards.",
        issuer: "TÜV Türk",
        validUntil: "2025-12-31",
        category: "Quality",
        image: "/api/placeholder/400/300",
      ...
      },
      {
        ...
        description:
          "Certificate documenting compliance of our products with European Union safety standards.",
      ...
      },
      {
        ...
        description:
          "Certificate of compliance with standards for our high visibility work clothes.",
      ...
      },
      {
        ...
        title: "OEKO-TEX Standard 100",
        description:
          "Certificate documenting that our textile products do not contain substances harmful to human health.",
      ...
      },
      {
        ...
        description:
          "Service competency certificate issued by Turkish Standards Institute.",
      ...
      },
      {
        ...
        description:
          "Occupational health and safety risk assessment competency certificate.",
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            {language === "TR"
              ? "Kalite ve Güvenlik Belgelerimiz"
            ...
            {[
              {
                standard: "ISO 9001",
                title:
                  language === "TR" ? "Kalite Yönetimi" : "Quality Management",
                description:
                  language === "TR"
              ...
              },
              {
                standard: "OEKO-TEX",
                title:
                  language === "TR" ? "Tekstil Güvenliği" : "Textile Safety",
                description:
                  language === "TR"
                    ? "Tekstil güvenlik standardı"
              ...
              <div key={index} className="text-center">
                ...
                <h4 className="text-base font-medium text-blue-200 mb-2">
                  {item.title}
                </h4>
