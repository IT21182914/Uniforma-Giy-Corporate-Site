...
const About = () => {
  ...
  const timeline = {
    TR: [
      { year: '1998', title: 'Kuruluş', description: 'İstanbul\'da küçük bir atölyede başladığımız serüvenimiz.' },
      { year: '2005', title: 'Büyüme', description: 'Üretim kapasitesini artırarak bölgesel lider olduk.' },
      { year: '2010', title: 'Sertifikasyon', description: 'ISO 9001 ve CE sertifikalarını aldık.' },
      { year: '2015', title: 'İhracat', description: 'Avrupa pazarına açılım gerçekleştirdik.' },
      { year: '2020', title: 'Teknoloji', description: 'Dijital dönüşüm sürecini tamamladık.' },
      { year: '2024', title: 'Liderlik', description: 'Türkiye\'nin en büyük iş kıyafeti üreticisi olduk.' }
    ],
    EN: [
      { year: '1998', title: 'Foundation', description: 'Our journey began in a small workshop in Istanbul.' },
      { year: '2005', title: 'Growth', description: 'We became a regional leader by increasing production capacity.' },
      { year: '2010', title: 'Certification', description: 'We obtained ISO 9001 and CE certificates.' },
      { year: '2015', title: 'Export', description: 'We expanded to the European market.' },
      { year: '2020', title: 'Technology', description: 'We completed the digital transformation process.' },
      { year: '2024', title: 'Leadership', description: 'We became Turkey\'s largest work clothing manufacturer.' }
    ]
  };
