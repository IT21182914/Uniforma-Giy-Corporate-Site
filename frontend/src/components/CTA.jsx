...
const CTA = ({
  ...
  const variants = {
    ...
    card: {
      container:
        "bg-white border border-gray-200 shadow-lg rounded-xl text-gray-900",
      content: "text-center",
    ...
    hero: {
      container:
        "bg-gradient-to-br from-blue-900 via-blue-800 to-orange-600 text-white relative overflow-hidden",
      content: "text-center relative z-10",
  ...
  const defaultContent = {
    TR: {
      ...
      subtitle:
        "Profesyonel iş kıyafetleri için hemen iletişime geçin ve özel teklifinizi alın.",
    ...
    EN: {
      ...
      subtitle:
        "Contact us now for professional work clothes and get your special offer.",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        <div className={currentVariant.content}>
          {/* Title */}
          <h2 className={currentVariant.title}>{title || content.title}</h2>
