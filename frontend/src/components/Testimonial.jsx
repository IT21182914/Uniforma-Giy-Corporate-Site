...
const Testimonial = ({ 
  ...
  const variants = {
    card: {
      ...
      avatar: 'w-12 h-12 bg-gradient-to-br from-blue-400 to-orange-400 rounded-full flex items-center justify-center text-white font-semibold',
    ...
    minimal: {
      ...
      author: 'space-y-2',
      avatar: 'w-16 h-16 bg-gradient-to-br from-blue-400 to-orange-400 rounded-full flex items-center justify-center text-white font-semibold mx-auto mb-3',
      name: 'font-semibold text-gray-900',
      position: 'text-sm text-gray-600',
      company: 'text-sm text-blue-600'
    },
    featured: {
      ...
      author: 'flex items-center space-x-4',
      avatar: 'w-14 h-14 bg-gradient-to-br from-blue-500 to-orange-500 rounded-full flex items-center justify-center text-white font-semibold text-lg',
  ...
  return (
    <div className={classNames(currentVariant.container, className)}>
      ...
      {/* Content */}
      <p className={currentVariant.content}>
        "{content}"
      </p>
      ...
      <div className={currentVariant.author}>
        ...
        <div className={variant === 'minimal' ? currentVariant.author : 'flex-1'}>
          <div className={currentVariant.name}>
            {testimonial.name}
          </div>
          <div className={currentVariant.position}>
            {position}
          </div>
          {testimonial.company && (
            <div className={currentVariant.company}>
              {testimonial.company}
            </div>
          )}
        </div>
