    ...
    TR: [
      {
        ...
        description: 'Tüm ürünlerimiz EN ve ISO standartlarına uygun olarak üretilir.',
        color: 'blue'
      },
      {
        id: 2,
    ...
    EN: [
      {
        ...
        description: 'All our products are manufactured in compliance with EN and ISO standards.',
        color: 'blue'
      },
      {
        id: 2,
        ...
        description: 'Production with high-quality materials and meticulous craftsmanship.',
        color: 'orange'
      },
      {
        id: 3,
        icon: Clock,
        title: 'Fast Delivery',
        description: 'Guaranteed delivery within 3-5 business days after order.',
        color: 'green'
      },
      {
        id: 4,
