      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          <div className="inline-flex items-center">
            <WhatsAppButton 
              variant="button"
              text={language === 'TR' ? 'WhatsApp ile İletişim' : 'Contact via WhatsApp'}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
          {[
            { value: '25+', label: language === 'TR' ? 'Yıl Deneyim' : 'Years Experience' },
            { value: '10K+', label: language === 'TR' ? 'Mutlu Müşteri' : 'Happy Customers' },
            { value: '50+', label: language === 'TR' ? 'Ürün Çeşidi' : 'Product Varieties' },
            { value: '99%', label: language === 'TR' ? 'Müşteri Memnuniyeti' : 'Customer Satisfaction' }
          ].map((stat, index) => (
            <div 
              key={index}
